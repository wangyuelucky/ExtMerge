Ext.define('Soims.controller.applicationAuditing.B1Tab', {
    extend: 'Ext.app.Controller',
    views: ['applicationAuditing.B1Tab'],
    ...
    init: function () {
        ...
        this.control({
            ...
            'auditb1tab button[itemId=save]': {
                click: this.onClickSaveBtn
            },
            'auditb1tab button[itemId=submit]': {
                click: this.onClickSubmitBtn
            },
            'auditb1tab button[itemId=close]': {
    ...
    generateParams: function (btn, saveOrSubmit) {
        var tabPanel = btn.up('panel'),
            ...
            auditType, auditContent, contentType, action;
        ...
        if (contentType && auditContent) {
            ...
            return { AuditType: auditType, AuditContent: auditContent, ContentType: contentType, Action: action, ApplicationID: appID, Competence: 'AuditB1' };
        }
        return null;
